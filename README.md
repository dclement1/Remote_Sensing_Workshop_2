...
- *Below is a map of the location of the project made with ESRI's ArcGIS.*
![This is map of the location of the project.](insetmap.png)

- *Below is an embeded Google map, in which you can view the loacation of the project.*
...
- *The first image below is an illustration of how LIDAR sensors are used to collect data. LIDAR sensors are commonly placed in the belly of light aircraft, which fly at relatively low altitudes.  Source: LIDAR-America.com*
